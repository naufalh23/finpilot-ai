...
-- CreateEnum
CREATE TYPE "WalletType" AS ENUM ('CASH', 'BANK', 'EWALLET', 'CREDIT_CARD', 'INVESTMENT');
...
-- CreateEnum
CREATE TYPE "LoanType" AS ENUM ('PERSONAL', 'BANK', 'VEHICLE', 'MORTGAGE', 'OTHER');

-- CreateEnum
CREATE TYPE "InvestmentType" AS ENUM ('STOCK', 'CRYPTO', 'GOLD', 'MUTUAL_FUND', 'ETF', 'OTHER');

-- CreateEnum
CREATE TYPE "InsightSeverity" AS ENUM ('INFO', 'SUCCESS', 'WARNING', 'DANGER');

-- CreateEnum
CREATE TYPE "ChatRole" AS ENUM ('USER', 'ASSISTANT');

-- CreateEnum
CREATE TYPE "NotificationKind" AS ENUM ('BUDGET', 'SUBSCRIPTION', 'CREDIT_CARD', 'LOAN', 'RECURRING', 'INSIGHT');
...
-- CreateIndex
CREATE INDEX "Wallet_userId_isArchived_idx" ON "Wallet"("userId", "isArchived");
...
-- CreateIndex
CREATE INDEX "Subscription_userId_status_nextBillingDate_idx" ON "Subscription"("userId", "status", "nextBillingDate");

-- CreateIndex
CREATE UNIQUE INDEX "CreditCard_walletId_key" ON "CreditCard"("walletId");
...
-- CreateIndex
CREATE INDEX "AiInsight_userId_dismissedAt_createdAt_idx" ON "AiInsight"("userId", "dismissedAt", "createdAt");
...
-- AddForeignKey
ALTER TABLE "CreditCard" ADD CONSTRAINT "CreditCard_walletId_fkey" FOREIGN KEY ("walletId") REFERENCES "Wallet"("id") ON DELETE CASCADE ON UPDATE CASCADE;
